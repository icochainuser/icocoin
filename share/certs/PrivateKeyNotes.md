...
unlocked to sign the Icocoin-Qt.app bundle.
...
allowing somebody to distribute a Icocoin-Qt.app or icocoin-qt-setup.exe with a valid
...
that the icocoin-qt.exe file inside the installer had not been tampered with.
