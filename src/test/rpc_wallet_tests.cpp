// Copyright (c) 2013-2015 The Icocoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CIcocoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CIcocoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CIcocoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CIcocoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CIcocoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CIcocoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
