...
{
    BOOST_CHECK(TestSplitHost("www.icocoin.org", "www.icocoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.icocoin.org]", "www.icocoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.icocoin.org:80", "www.icocoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.icocoin.org]:80", "www.icocoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8508", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8508", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8508", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:8508", "::", 8333));
    BOOST_CHECK(TestSplitHost("::8508", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":8508", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:8508", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8508", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8508", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
