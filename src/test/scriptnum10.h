...
#ifndef ICOCOIN_TEST_SCRIPTNUM10_H
#define ICOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Icocoin Core 0.10.0, for cross-comparison.
 */
public:
