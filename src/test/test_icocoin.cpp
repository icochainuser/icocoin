...
#define BOOST_TEST_MODULE Icocoin Test Suite

#include "test_icocoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_icocoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
