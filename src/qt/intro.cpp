...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/icocoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Icocoin Core"),
     ...
     * override -datadir in the icocoin.conf file in the default data directory
     * (to be consistent with icocoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
