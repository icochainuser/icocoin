...
#ifndef ICOCOIN_QT_ICOCOINUNITS_H
#define ICOCOIN_QT_ICOCOINUNITS_H
...
/** Icocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IcocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IcocoinUnits(QObject *parent);

    /** Icocoin units.
      @note Source: https://en.icocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ICO,
...
typedef IcocoinUnits::Unit IcocoinUnit;

#endif // ICOCOIN_QT_ICOCOINUNITS_H
