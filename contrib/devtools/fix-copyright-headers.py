...
// Copyright (c) 2009-2012 The Icocoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Icocoin/$1-%s The Icocoin/' %s"
REGEX_CURRENT= re.compile("%s The Icocoin" % year)
