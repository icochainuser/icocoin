Icocoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/icocoin/files/Icocoin/icocoin-0.5.4/
...
http://gitorious.org/icocoin/icocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Icocoin-Qt notifications under Growl 1.3.
Increase required age of Icocoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIcocoin properly when installing Icocoin-Qt over it. (Windows)
