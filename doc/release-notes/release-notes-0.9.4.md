Icocoin Core version 0.9.4 is now available from:

  https://icocoin.org/bin/0.9.4/
...
this update is incompatible with the Icocoin system and could lead to consensus
forks.

Icocoin Core released binaries from https://icocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~icocoin/+archive/ubuntu/icocoin
- A third-party or self-compiled Icocoin Core

upgrade to Icocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
