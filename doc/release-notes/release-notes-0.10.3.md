Icocoin Core version 0.10.3 is now available from:

  <https://icocoin.org/bin/icocoin-core-0.10.3/>
...
(see https://github.com/icocoin/icocoin/pull/6793, as well as the 0.11.0
