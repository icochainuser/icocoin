Download URL: https://sourceforge.net/projects/icocoin/files/Icocoin/icocoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ICO fee schedule (users still pay 0.01 ICO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #icocoin00 - #icocoin99
