Icocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/icocoin/files/Icocoin/icocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Icocoin
...
New/changed settings (command-line or icocoin.conf file)
--------------------------------------------------------
