Icocoin Core version 0.9.2.1 is now available from:

  https://icocoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ICO to 0.01 ICO
...
- Fix "Start icocoin on system login"
