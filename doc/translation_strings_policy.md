...
This document provides guidelines for internationalization of the Icocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `icocoin_en.ts` remains unchanged.
